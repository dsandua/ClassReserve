              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {filteredStudents.map((student) => (
                  <tr key={student.id}>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm text-gray-900">{getBookingCount(student.id)}</div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm text-gray-500">23/04/2025</div>
                    </td>
          ...
          <div className="bg-white rounded-lg shadow-xl max-w-4xl w-full mx-4 animate-slide-in">
            ...
            <div className="p-4">
              ...
              <div className="border-t border-gray-200 pt-4">
                <div className="flex items-center justify-between mb-4">
                  <h5 className="text-base font-medium text-gray-900">Historial de clases</h5>
                  <button 
